...
const steps = [
  { num: "01", title: "Avaliação online do movimento", desc: "Por vídeo, analisamos seus padrões de movimento e identificamos a origem da dor.", img: step01 },
  { num: "02", title: "Plano de exercícios personalizado", desc: "Você recebe um programa completo de exercícios feito para o seu caso.", img: step02 },
  { num: "03", title: "Acompanhamento semanal", desc: "Reuniões semanais online para ajustar exercícios e monitorar progresso.", img: step03 },
  { num: "04", title: "Progressão segura", desc: "Evolução gradual para que você retome sua rotina com segurança.", img: step04 },
];
