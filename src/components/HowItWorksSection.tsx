      ...
      <div className="container max-w-4xl space-y-20 relative">
        ...
        <div className="space-y-7 relative">
          ...
          {steps.map(({ icon: Icon, num, title, desc }, i) => (
            <AnimateOnScroll key={num} delay={i * 140}>
              <div className="flex items-start gap-7 md:gap-9 rounded-3xl bg-background p-8 md:p-10 shadow-card hover:shadow-card-hover transition-all duration-400 relative border border-border hover:border-primary/20 hover:-translate-y-1">
                <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-2xl gradient-primary text-cta-foreground font-bold text-lg shadow-cta relative z-10 font-body">
                  {num}
                </div>
        ...
        <AnimateOnScroll className="text-center">
          <div className="rounded-3xl gradient-primary p-10 md:p-14 text-center space-y-6 shadow-elegant relative overflow-hidden">
            <div className="absolute top-0 right-0 w-60 h-60 rounded-full bg-cta-foreground/[0.05] blur-3xl" />
            ...
            <Button variant="whatsapp" size="xl" className="group relative z-10" asChild>
