...
const CtaSection = () => {
  return (
    <section className="gradient-dark py-20 md:py-40 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-primary/10 blur-3xl animate-pulse-soft" />
      ...
      <div className="container max-w-3xl text-center space-y-10 relative">
        <AnimateOnScroll>
          <div className="flex justify-center mb-6">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/20 animate-bounce-subtle hover:bg-primary/30 transition-colors duration-300">
