...
const HeroSection = () => {
  return (
    <section id="inicio" className="relative overflow-hidden gradient-hero pt-28 md:pt-40 pb-20 md:pb-32">
      {/* Decorative shapes */}
      <div className="absolute top-20 right-0 w-[600px] h-[600px] rounded-full bg-primary/[0.04] blur-3xl" />
        ...
        <div className="grid gap-16 lg:grid-cols-2 items-center">
          <AnimateOnScroll animation="animate-fade-in-left" className="space-y-10">
            ...
            <ul className="space-y-4">
              {benefits.map((b, i) => (
                <li key={b} className="flex items-center gap-3.5 text-foreground">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full gradient-primary shrink-0 shadow-cta">
          ...
          <AnimateOnScroll animation="animate-fade-in-right" className="relative">
            ...
            <div className="absolute -inset-8 rounded-[2.5rem] bg-secondary/50 -rotate-3 hidden lg:block" />
            ...
            <img
              ...
              className="relative rounded-3xl shadow-elegant w-full object-cover aspect-[4/3] z-10"
              loading="eager"
            />
            {/* Floating badge */}
            <div className="absolute -bottom-6 -left-4 md:-left-8 rounded-2xl bg-background shadow-card-hover p-5 flex items-center gap-4 animate-float z-20 border border-border">
            ...
            <div className="absolute -top-3 -right-3 md:-right-6 rounded-2xl bg-background shadow-card-hover px-5 py-3 animate-float z-20 border border-border" style={{ animationDelay: "1.5s" }}>
